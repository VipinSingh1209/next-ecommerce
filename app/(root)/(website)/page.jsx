import MainSlider from '@/components/ui/Application/Website/MainSlider'
import Image from 'next/image'
import Link from 'next/link'
import React from 'react'
import banner1 from '@/public/assets/images/banner1.png'
import banner2 from '@/public/assets/images/banner2.png'
import FeaturedProduct from '@/components/ui/Application/Website/FeaturedProduct'
import advertisingBanner from '@/public/assets/images/advertising-banner.png'
import Testimonial from '@/components/ui/Application/Website/Testimonial'
...
const Home = () => {
  return (
    ...
    <section className='lg:px-32 px-4 sm:pt-20 pt-5 pb-10' >
      <div className='grid grid-cols-1 sm:grid-cols-2 sm:gap-10 gap-2' >
    ...
    <div className='grid lg:grid-cols-4 sm:grid-cols-2 grid-cols-1 gap-10 ' >
      ...
      <div className='text-center' >
        ...
        <p className='' >Risk-free shopping with easy returns.</p>
      </div>
       ...
       <div className='text-center' >
        ...
        <p className='' >No extra costs, just the price you see.</p>
      </div>
      ...
      <div className='text-center' >
        ...
        <p className='' >24/7 support, alway here just for you.</p>
      </div>
