...
const LatestReview = () => {
  ...
  if(loading) return <div className='h-full w-full justify-center items-center'>Loading...</div>
  
    if(!latestReview || latestReview.length === 0){
      return <div className='h-full w-full flex justify-center items-center'>
        <Image src={notFound.src} width={notFound.width} height={notFound.height} alt='notFound' className='w-20'/>
      </div>
    }
