...
export const DT_COUPON_COLUMN = [
   ...
   
    {
        ...
        Cell: ({renderedCellValue}) => (
            new Date() >  Date(renderedCellValue) ? <Chip color="error" label={dayjs(renderedCellValue).format('DD/MM/YYYY')}/> : <Chip color="success" label={dayjs(renderedCellValue).format('DD/MM/YYYY')}/> 
        )
