...
import logoBlack from '@/public/assets/images/wydlogoblackk.png'
  ...
  return (
      ...
      <SidebarHeader className="border-b h-14 p-0">
        <div className='flex justify-between items-center px-4'>
            <Image src={logoBlack.src} height={50} width={logoBlack.width} className='block dark:hidden h-[50px] w-auto ml-4' alt='logo-dark' />
