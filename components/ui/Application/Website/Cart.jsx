        ...
        <div className="h-[calc(100vh-40px)] pb-10 ">
          ...
          <div className="h-32 border-t pt-5 px-2">
            ...
            <div className="flex justify-between gap-2 mt-3" >
              <Button type="button" asChild variant="secondary" className='w-[180px]' onClick={()=> setOpen(false)}>
                <Link href={WEBSITE_CART}>
                  View Cart
                </Link>
              </Button>
              <Button type="button" asChild  className='w-[180px]'onClick={()=> setOpen(false)} >
              {cart.count ?
